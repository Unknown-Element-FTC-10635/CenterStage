...
@Autonomous(name = "🟥 Center 2+0", group = "red")
public class CRI_RedCenter20 extends OpMode {
...
//        }
    ...
    private void buildPaths() {
        ...
        leftPath = driveTrain.trajectorySequenceBuilder(startPose)
                .setReversed(false)
                .forward(4)
                .lineToLinearHeading(new Pose2d(-11, -30, Math.toRadians(180)))
                .forward(3)
                .lineToLinearHeading(new Pose2d(2, -55, Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(40, -51, Math.toRadians(180)))
                .waitSeconds(1)
                .lineToLinearHeading(new Pose2d(77, -25, Math.toRadians(180)))
                .build();

        rightPath = driveTrain.trajectorySequenceBuilder(startPose)
                .setReversed(false)
                .forward(4)
                .lineToLinearHeading(new Pose2d(-2, -45, Math.toRadians(90)))
                .setReversed(true)
