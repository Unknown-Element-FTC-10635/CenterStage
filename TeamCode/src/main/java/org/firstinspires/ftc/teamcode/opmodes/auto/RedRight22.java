...
public class RedRight22 extends OpMode {
    ...
    private TrajectorySequence  preloadDeliveryLeft, preloadDeliveryBackdropLeft, preloadDeliveryCenter,
            ...
            toCommonPathLeft, toCommonPathCenter, toCommonPathRight, toStackRight, toStackLeft, toStackCenter, backToKnownPositionLeft, stackDeliveryBackdropLeft;
    ...
    public void init() {
        ...
        colorSensor = new StackColorSensor(hardwareMap, false);
    ...
    public void start() {
        ...
        switch (spikePosition) {
            case LEFT:
                ...
                toStack = toStackLeft;
                backToKnownPosition = backToKnownPositionLeft;
    ...
    private void buildPaths() {
        ...
        toCommonPathLeft = driveTrain.trajectorySequenceBuilder(preloadDeliveryLeft.end())
                .back(8)
                .lineToLinearHeading(new Pose2d(22,-18, Math.toRadians(180)))
                .build();
        ...
        toStackRight = driveTrain.trajectorySequenceBuilder(toCommonPathCenter.end())
                .lineToLinearHeading(new Pose2d(0, -14, Math.toRadians(180)))
                .setReversed(false)
                .lineToLinearHeading(new Pose2d(-60, -12, Math.toRadians(180)))
                .build();

        toStackLeft = driveTrain.trajectorySequenceBuilder(toCommonPathLeft.end())
                .lineToLinearHeading(new Pose2d(0, -10, Math.toRadians(180)))
                .setReversed(false)
                .lineToLinearHeading(new Pose2d(-59, -9, Math.toRadians(180)))
                .build();

        backToKnownPosition = driveTrain.trajectorySequenceBuilder(new Pose2d(-65, -15, Math.toRadians(180)))
                .setReversed(true)
                .lineToLinearHeading(new Pose2d(-35, -13, Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(28, -14, Math.toRadians(180)))
                .build();

        backToKnownPositionLeft = driveTrain.trajectorySequenceBuilder(new Pose2d(-65, -15, Math.toRadians(180)))
                .setReversed(true)
                .lineToLinearHeading(new Pose2d(-35, -13, Math.toRadians(180)))
        ...
        stackDeliveryBackdropLeft = driveTrain.trajectorySequenceBuilder(backToKnownPositionLeft.end())
                .setReversed(true)
                .lineToLinearHeading(new Pose2d(44, -33, Math.toRadians(180)))
                .build();

        park = driveTrain.trajectorySequenceBuilder(backToKnownPosition.end())
                .setReversed(true)
                .lineToLinearHeading(new Pose2d(53, -13, Math.toRadians(0)))
                .build();
